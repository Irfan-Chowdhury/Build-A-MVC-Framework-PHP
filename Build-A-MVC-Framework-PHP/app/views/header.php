...
#postinput{border:1px solid #ddd;margin-bottom:5px;padding:5px;width:400px;font-size:16px}
...
.widget h2{border: 1px solid #ddd;margin: 0 0 lOpx;padding: 4px lOpx;} 
.widget ul{margin: 0;padding: 0;list-style: none;} 
.widget ul li{} 
.widget ul li a {background: #3399ff none repeat scroll 0 0;color: #fff;display: block; 
...
.menu{float: left;margin-top: 5px;font-size: 18px} 
.menu a{text-decoration: none;background: #f2f2f2; border: 1px solid #999; color: #666; padding: 5px 10px } 
.search{float:right;} 
.catsearch{border: 1px solid #ddd;font-size: 16px;margin-bottom: Spx;padding: 5px;width: 228 px;cursor: pointer;} 
...
<body>
  ...
  <div class="content">
   <span style="float:right;"><a href="<?php echo BASE_URL; ?>">Visit Website</a></span>

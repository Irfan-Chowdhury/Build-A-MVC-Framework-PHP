...
?>
<form action="http://localhost/TWLP/16.Building-Your-Own-MVC-Framework-PHP/Original_File
/Category/insertCategory" method="post">
    <table>
        <tr>
            <td>Category Name</td>
            <td><input type="text" name="categoryName" required="1"></td>
        </tr>
        <tr>
